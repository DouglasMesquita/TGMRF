...
// dens_beta_cpp
double dens_beta_cpp(arma::vec x_beta, arma::vec x_eps, double x_nu, arma::mat sigma, Rcpp::List& params);
RcppExport SEXP _TGMRF_dens_beta_cpp(SEXP x_betaSEXP, SEXP x_epsSEXP, SEXP x_nuSEXP, SEXP sigmaSEXP, SEXP paramsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(dens_beta_cpp(x_beta, x_eps, x_nu, sigma, params));
    return rcpp_result_gen;
END_RCPP
}
// dens_eps_cpp
