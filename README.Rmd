...
`library(TGMRF)` will load **tgmrf**, a function to fit Poisson regression models. The user can choose for several models to model the poisson intensities: **gamma-var**, **gamma-shape**, **gamma-scale** and **log-normal**.
